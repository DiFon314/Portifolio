  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <div className="font-mono-tech text-xs uppercase tracking-widest text-brand">Error / 404</div>
        <h1 className="mt-4 text-5xl font-light text-foreground">Página não encontrada</h1>
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <div className="font-mono-tech text-xs uppercase tracking-widest text-destructive">System / Error</div>
        <h1 className="mt-4 text-3xl font-light text-foreground">Algo deu errado</h1>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Diogo Fonseca — Portfólio Técnico" },
      {
        name: "description",
        content:
          "Portfólio profissional de engenharia elétrica e desenvolvimento de software. Projetos, serviços executados, calculadoras técnicas e produções acadêmicas.",
      },
      ...
      { property: "og:title", content: "Diogo Fonseca — Portfólio Técnico" },
      {
        ...
        content:
          "Projetos de engenharia elétrica, software, serviços executados e ferramentas técnicas.",
      },
